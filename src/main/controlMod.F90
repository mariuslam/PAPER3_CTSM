...
contains
  ...
  subroutine control_init(dtime)
    ...
    namelist /clm_inparm/ fates_paramfile, use_fates,   &
          ...
          use_fates_fixed_biogeog, use_fates_hydrohard, &
          use_fates_nocomp,use_fates_frosthard,         &
          use_fates_sp,                                 &
  ...
  subroutine control_spmd()
    ...
    call mpi_bcast (use_fates_hydrohard, 1, MPI_LOGICAL, 0, mpicom, ier) !marius
    call mpi_bcast (use_fates_frosthard, 1, MPI_LOGICAL, 0, mpicom, ier) !marius
